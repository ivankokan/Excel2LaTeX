...
Nearly all formatting is supported (**bold**, *italic*, border lines, multicolumn cells, …).
Works with current versions of Excel including Excel 2010 and Excel Mac 11.
...
Please report bugs via the bug tracker at https://github.com/krlmlr/Excel2LaTeX/issues.
